---
title: "Etude de l'évolution de l'hydromorphologie au niveau d'une station Carhyce"
author: "Imane PALAGI"
date: "`r Sys.Date()`"
output:
  html_document:
...
**Ce document n'est ainsi pas spécifique à une station en particulier : il est sensé pouvoir être utilisé pour étudier n'importe quelle station Carhyce des Hauts-de-France pour laquelle on dispose d'un code de station (toutes prospections y compris hors OFB). Ainsi, l'évolution de l'hydromorphologie ne sera pas interprétée finement (explication fine des processus, présentation des conclusions sur l'état hydromorphologique de la station etc.) ou mise en relation avec le dire d'expert, car ceci est dépendant de la station étudiée. En revanche, pour chaque métrique, une explication de celle-ci ainsi que des éléments aidant l'interprétation (valeurs seuils, classes de qualité etc.) seront fournis pour aider le lecteur à comprendre les résultats présentés.**
...
Elle appartient à l'hydroécorégion 1 :
...
mapview(map_station) #affichage de la carte interactive 
